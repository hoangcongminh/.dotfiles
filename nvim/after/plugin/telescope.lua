...
vim.keymap.set('n', '<space>s', telescope_builtin.current_buffer_fuzzy_find, opts)
vim.keymap.set('n', '<space>fg', telescope_builtin.live_grep, opts)
vim.keymap.set('n', '<space>fb', telescope_builtin.buffers, opts)
vim.keymap.set('n', '<space>fo', telescope_builtin.oldfiles, opts)
vim.keymap.set('n', '<space>qf', telescope_builtin.quickfix, opts)
vim.keymap.set('n', '<space>fr', telescope_builtin.resume, opts)
vim.keymap.set('n', '<space>lj', telescope_builtin.jumplist, opts)
vim.keymap.set('n', '<space>ts', telescope_builtin.treesitter, opts)
