local function map(_,bufnr)
  ...
  buf_set_option('omnifunc', 'vlua.vim.lsp.omnifunc')
  ...
  -- buf_set_keymap('x', '<space>aw', '<cmd>lua vim.lsp.buf.range_code_action()<CR>', opts)
  buf_set_keymap('n', '<space>aw', ':CodeActionMenu<CR>', opts)
